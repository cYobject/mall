...
public class ProductCategoryController {
     ...
     */
    @GetMapping
    public APIResult<Page<ProductCategory>> queryByPage(ProductCategory productCategory) {
     ...
     */
    @GetMapping("{id}")
    public APIResult<ProductCategory> queryById(@PathVariable("id") Long id) {
        return APIResult.success();
    }
     ...
     */
    @PostMapping
    public APIResult<ProductCategory> add(ProductCategory productCategory) {
        return APIResult.success();
    }
     ...
     */
    @PutMapping
    public APIResult<ProductCategory> edit(ProductCategory productCategory) {
        return APIResult.success();
    }
