...
(
    ...
    `sku_id`             varchar(32)    DEFAULT NULL COMMENT '商品sku编号',
...
(
    ...
    `order_id`        varchar(32)    DEFAULT NULL COMMENT 'order_id',
    `sku_id`          varchar(32)    DEFAULT NULL COMMENT '退货商品id',
...
(
    ...
    `user_level`            tinyint DEFAULT NULL COMMENT '会员等级【0-不限会员等级，全部通用；其他-对应的其他会员等级】',
    PRIMARY KEY (`id`)
...
(
    `id`              varchar(32) NOT NULL COMMENT 'id',
    `order_return_id` varchar(32)    DEFAULT NULL COMMENT '退款的订单',
